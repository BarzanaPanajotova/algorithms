...
/**
 * This is implementation Insertion Sort in Java. The basic algorithm definition
 * is to sort the elements of the given array by going through every single
 * value of the array and inserting it at the right place in the preceding part
 * of the array.
 * 
...
public final class InsertionSort {
	 ...
	 * @return new instance of a sorted representation of the input array.
	 */
